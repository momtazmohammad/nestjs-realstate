-- CreateEnum
CREATE TYPE "PropertyType" AS ENUM ('RESIDENTAIL', 'CONDO');
...
-- AddForeignKey
ALTER TABLE "Message" ADD CONSTRAINT "Message_realor_id_fkey" FOREIGN KEY ("realor_id") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
